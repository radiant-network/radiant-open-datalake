...
/** One row per Ensembl gene of the GFF3 release. */
case class EnsemblGene_v1(rc: RuntimeETLContext, version: String, rawStorage: String, tablePrefix: String, database: Option[String] = None, override val warehouse: Option[String] = None)
  extends ContractETLP(rc, sourceDatasetId = "normalized_ensembl_gene", tablePrefix, major = 1, database) {
  ...
  override def transformSingle(data: Map[String, DataFrame],
    ...
    EnsemblGff.genes(EnsemblGff.base(data(raw_ensembl_gff3.id)))
