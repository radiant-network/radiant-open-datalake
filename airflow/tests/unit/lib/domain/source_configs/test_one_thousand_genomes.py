...
def test_get_latest_version_picks_most_recent_release(one_thousand_genomes_source_config, thousand_genomes_listing_html):
...
def test_get_latest_version_ignores_parent_and_sort_links(one_thousand_genomes_source_config):
    html = (
        '<a href="/vol1/ftp/">Parent Directory</a>'
